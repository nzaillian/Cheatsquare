This application provides a simple, visual interface for the foursquare service (no formal affiliation).  More specifically, it provides
a simple means of checking into arbitrary venues by VID.
...
It is important to note that at present, py2app does not support x86_64, so if you would like to create a 64bit app bundle,
you'll have to find some other way of doing it.
